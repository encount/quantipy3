...
def read_forsta_api(self, projectid, public_url, idp_url, client_id,
                    client_secret, schema_vars, data_filter, verbose):
    json_data, json_meta = get_surveys(projectid, public_url, idp_url,
...
def write_forsta_api(self, projectid, public_url, idp_url, client_id,
    ...
    return quantipy_to_forsta(self, projectid, public_url, idp_url, client_id,
                              client_secret, schema_vars)
